import { require_react_dom } from '/build/_shared/chunk-U4FRFQSK.js';
...
function createRouter(init) {
  ...
  async function startRedirectNavigation(request, redirect4, _temp2) {
    ...
    let redirectHistoryAction =
      replace3 === true || redirect4.response.headers.has('X-Remix-Replace')
        ? Action.Replace
        : Action.Push;
    ...
    if (
      redirectPreserveMethodStatusCodes.has(redirect4.response.status) &&
      activeSubmission &&
...
function createStaticHandler(routes, opts) {
  ...
  async function query(request, _temp3) {
    let { requestContext, skipLoaderErrorBubbling, unstable_dataStrategy } =
  ...
  async function queryRoute(request, _temp4) {
    let { routeId, requestContext, unstable_dataStrategy } =
  ...
  if (routeId) {
    ...
    let dataChildren = convertRoutesToDataRoutes(
      ...
      [
        ...
        'patch',
        String(
          ((_route$children = route.children) == null
            ? void 0
    ...
    DeferredData = class {
      ...
      trackPromise(key, value) {
        ...
        let promise = Promise.race([value, this.abortPromise]).then(
          (data3) => this.onSettle(promise, key, void 0, data3),
...
function DefaultErrorComponent() {
  ...
  if (true) {
    ...
    devInfo = /* @__PURE__ */ React.createElement(
      React.Fragment,
      null,
...
function useNavigateStable() {
  let { router: router2 } = useDataRouterContext(
    DataRouterHook.UseNavigateStable
  );
...
function RouterProvider(_ref) {
  ...
  React.useEffect(() => {
    true
      ? warning(
          fallbackElement == null || !router2.future.v7_partialHydration,
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          state.initialized || router2.future.v7_partialHydration
...
function Navigate(_ref4) {
  let { to, replace: replace3, state, relative } = _ref4;
  !useInRouterContext()
    ? true
      ? invariant(
          false,
...
function mapRouteProperties(route) {
  ...
  if (route.HydrateFallback) {
    ...
    Object.assign(updates, {
      hydrateFallbackElement: /* @__PURE__ */ React.createElement(
...
var init_dist = __esm({
  'node_modules/react-router/dist/index.js'() {
    ...
    defaultErrorElement = /* @__PURE__ */ React.createElement(
...
function useSubmit() {
  let { router: router2 } = useDataRouterContext2(DataRouterHook2.UseSubmit);
...
function useFetcher(_temp3) {
  ...
  let { router: router2 } = useDataRouterContext2(DataRouterHook2.UseFetcher);
...
function useScrollRestoration(_temp4) {
  ...
  let { router: router2 } = useDataRouterContext2(
    DataRouterHook2.UseScrollRestoration
  );
...
var init_dist2 = __esm({
  'node_modules/react-router-dom/dist/index.js'() {
    ...
    FetchersContext = /* @__PURE__ */ React2.createContext(
      /* @__PURE__ */ new Map()
    );
    if (true) {
    ...
    NavLink = /* @__PURE__ */ React2.forwardRef(function NavLinkWithRef(
      _ref8,
      ref
    ) {
      let {
...
var require_server = __commonJS({
  'node_modules/react-router-dom/server.js'(exports) {
    ...
    function StaticRouterProvider2({
      ...
      !(router$1 && context)
        ? true
          ? router2.UNSAFE_invariant(
              false,
              'You must provide `router` and `context` to <StaticRouterProvider>'
            )
          : router2.UNSAFE_invariant(false)
        : void 0;
      ...
      return /* @__PURE__ */ React__namespace.createElement(
        ...
        /* @__PURE__ */ React__namespace.createElement(
          ...
          /* @__PURE__ */ React__namespace.createElement(
            ...
            /* @__PURE__ */ React__namespace.createElement(
              reactRouterDom.UNSAFE_FetchersContext.Provider,
              {
                value: fetchersContext,
              },
              /* @__PURE__ */ React__namespace.createElement(
                reactRouterDom.UNSAFE_ViewTransitionContext.Provider,
                {
                  value: {
                    isTransitioning: false,
                  },
    ...
    function DataRoutes3({ routes, future, state }) {
    ...
    function createStaticRouter2(routes, context, opts = {}) {
      let manifest = {};
      let dataRoutes = router2.UNSAFE_convertRoutesToDataRoutes(
        routes,
        reactRouter.UNSAFE_mapRouteProperties,
        void 0,
        manifest
      );
    ...
    function encodeLocation(to) {
      ...
      href = href.replace(/ $/, '%20');
      let encoded = ABSOLUTE_URL_REGEX4.test(href)
        ? new URL(href)
...
async function loadRouteModule(route, routeModulesCache) {
  ...
  try {
    ...
    console.error(error);
    if (
      window.__remixContext.isSpaMode && // @ts-expect-error
...
async function prefetchStyleLinks(route, routeModule) {
  ...
  let descriptors = [
    ((_route$css = route.css) === null || _route$css === void 0
      ? void 0
      : _route$css.map((href) => ({
          rel: 'stylesheet',
          href,
        }))) ?? [],
    ((_routeModule$links = routeModule.links) === null ||
    _routeModule$links === void 0
      ? void 0
      : _routeModule$links.call(routeModule)) ?? [],
  ].flat(1);
...
function isDeferredResponse(response) {
  ...
  return !!(
    ...
    _response$headers$get.match(/text\/remix-deferred/)
  );
}
  ...
  if (done) {
    ...
    return /* @__PURE__ */ React3.createElement(
      ...
      /* @__PURE__ */ React3.createElement(
        React3.Suspense,
        null,
        /* @__PURE__ */ React3.createElement(StreamTransfer, {
          context,
    ...
    matches.map(async (m) => {
      ...
      let result = await m.resolve(async (handler) => {
        let result2 = await handler(async () => {
          ...
          let init = await createRequestInit(request);
          let { data: data3, status } = await fetchAndDecode(url, init);
          actionStatus = status;
      ...
      m.resolve(async (handler) => {
        ...
        if (manifest.routes[m.route.id].hasClientLoader) {
          result = await handler(async () => {
            ...
            let { data: data3 } = await fetchAndDecode(url, init);
          ...
          result = await handler(async () => {
            if (!singleFetchPromise) {
              url = addRevalidationParam(
                manifest,
                routeModules,
                matches.map((m2) => m2.route),
                matches.filter((m2) => m2.shouldLoad).map((m2) => m2.route),
                url
              );
...
function addRevalidationParam(
  ...
  let needsParam = matchedRoutes.some((r) => {
    ...
    return (
      ((_routeModules$r$id = routeModules[r.id]) === null ||
      _routeModules$r$id === void 0
        ? void 0
        : _routeModules$r$id.shouldRevalidate) ||
      ((_manifest$routes$r$id = manifest.routes[r.id]) === null ||
      _manifest$routes$r$id === void 0
        ? void 0
        : _manifest$routes$r$id.hasClientLoader)
    );
  });
  if (!needsParam) {
    return url;
  ...
  let loadIds = genRouteIds(
    loadRoutes
      .filter((r) => {
        ...
        return !(
          (_manifest$routes$r$id2 = manifest.routes[r.id]) !== null &&
          _manifest$routes$r$id2 !== void 0 &&
          _manifest$routes$r$id2.hasClientLoader
        );
      })
      .map((r) => r.id)
  );
...
function BoundaryShell({ title, renderScripts, isOutsideRemixApp, children }) {
  ...
  if (
    (_routeModules$root = routeModules.root) !== null &&
    _routeModules$root !== void 0 &&
    _routeModules$root.Layout &&
    !isOutsideRemixApp
  ) {
    return children;
  }
  return /* @__PURE__ */ React4.createElement(
    ...
    /* @__PURE__ */ React4.createElement(
      ...
      /* @__PURE__ */ React4.createElement('title', null, title)
    ),
    /* @__PURE__ */ React4.createElement(
      'body',
      null,
      /* @__PURE__ */ React4.createElement(
        ...
        children,
        renderScripts
          ? /* @__PURE__ */ React4.createElement(Scripts, null)
          : null
      )
    )
  );
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary
    ...
    : route.id === 'root'
    ? () =>
        /* @__PURE__ */ React6.createElement(RemixRootDefaultErrorBoundary, {
          error: useRouteError(),
        })
    : void 0;
  if (route.id === 'root' && routeModule.Layout) {
    return {
      ...(Component3
        ? {
            element: /* @__PURE__ */ React6.createElement(
              routeModule.Layout,
              null,
              /* @__PURE__ */ React6.createElement(Component3, null)
            ),
          }
        : {
      ...
      ...(ErrorBoundary
        ? {
            errorElement: /* @__PURE__ */ React6.createElement(
              routeModule.Layout,
              null,
              /* @__PURE__ */ React6.createElement(ErrorBoundary, null)
            ),
          }
        : {
            ErrorBoundary,
      ...
      ...(HydrateFallback
        ? {
            hydrateFallbackElement: /* @__PURE__ */ React6.createElement(
              routeModule.Layout,
              null,
              /* @__PURE__ */ React6.createElement(HydrateFallback, null)
            ),
          }
        : {
            HydrateFallback,
    ...
    if (routeModule) {
      ...
      let initialData =
        initialState === null || initialState === void 0
          ? void 0
          : (_initialState$loaderD = initialState.loaderData) === null ||
            _initialState$loaderD === void 0
          ? void 0
          : _initialState$loaderD[route.id];
      let initialError =
        initialState === null || initialState === void 0
          ? void 0
          : (_initialState$errors = initialState.errors) === null ||
            _initialState$errors === void 0
          ? void 0
          : _initialState$errors[route.id];
      let isHydrationRequest =
        needsRevalidation == null &&
        (((_routeModule$clientLo = routeModule.clientLoader) === null ||
        _routeModule$clientLo === void 0
          ? void 0
          : _routeModule$clientLo.hydrate) === true ||
          !route.hasLoader);
      ...
      if (!route.hasClientAction) {
        dataRoute.action = ({ request }, singleFetch) =>
          prefetchStylesAndCallHandler(() => {
            if (isSpaMode) {
              throw noActionDefinedError('clientAction', route.id);
            }
      ...
      dataRoute.lazy = async () => {
        ...
        if (mod.clientLoader) {
          ...
          lazyRoute.loader = (args, singleFetch) =>
            clientLoader({
              ...args,
              async serverLoader() {
                preventInvalidServerHandlerCall('loader', route, isSpaMode);
        ...
        if (mod.clientAction) {
          ...
          lazyRoute.action = (args, singleFetch) =>
            clientAction({
              ...args,
              async serverAction() {
                preventInvalidServerHandlerCall('action', route, isSpaMode);
...
function useFogOFWarDiscovery(
  ...
  React7.useEffect(() => {
    ...
    if (
      ...
      ((_navigator$connection = navigator.connection) === null ||
      _navigator$connection === void 0
        ? void 0
        : _navigator$connection.saveData) === true
    ) {
      return;
    }
...
function getFogOfWarPaths(fogOfWar2, router2) {
  let { knownGoodPaths, known404Paths, nextPaths } = fogOfWar2;
...
async function fetchAndApplyManifestPatches(
  ...
  let patches = Object.values(data3.patches).reduce(
    (acc, route) =>
  ...
  ({ to, prefetch = 'none', discover = 'render', ...props }, forwardedRef) => {
    ...
    return /* @__PURE__ */ React8.createElement(
      ...
      /* @__PURE__ */ React8.createElement(
        NavLink,
        _extends4({}, props, prefetchHandlers, {
      ...
      shouldPrefetch && !isAbsolute
        ? /* @__PURE__ */ React8.createElement(PrefetchPageLinks, {
            page: href,
          })
        : null
    );
...
var Form2 = /* @__PURE__ */ React8.forwardRef(
  ({ discover = 'render', ...props }, forwardedRef) => {
    let isAbsolute =
      ...
      ABSOLUTE_URL_REGEX3.test(props.action);
    return /* @__PURE__ */ React8.createElement(
      Form,
      _extends4({}, props, {
        ref: forwardedRef,
...
function Links() {
  ...
  return /* @__PURE__ */ React8.createElement(
    ...
    null,
    criticalCss
      ? /* @__PURE__ */ React8.createElement('style', {
          dangerouslySetInnerHTML: {
            __html: criticalCss,
          },
        })
...
function PrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
  ...
  if (!future.unstable_singleFetch) {
    ...
    if (url.searchParams.get('_routes') !== '') {
      linksToRender = /* @__PURE__ */ React8.createElement(
        'link',
        _extends4(
          {
...
function Scripts(props) {
  ...
  let initialScripts = React8.useMemo(() => {
    ...
    let activeDeferreds = future.unstable_singleFetch
      ? void 0
      : staticContext === null || staticContext === void 0
      ? void 0
    ...
    let routeModulesScript = !isStatic
      ? ' '
      : `${
          (_manifest$hmr = manifest.hmr) !== null &&
          _manifest$hmr !== void 0 &&
          _manifest$hmr.runtime
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  if (!isStatic && typeof __remixContext === 'object' && __remixContext.a) {
    for (let i = 0; i < __remixContext.a; i++) {
      deferredScripts.push(
        /* @__PURE__ */ React8.createElement(DeferredHydrationScript, {
          key: i,
          scriptProps: props,
          serializeData: serializeDataImp,
          serializeError: serializeErrorImp,
...
function DeferredHydrationScript({
  ...
  return /* @__PURE__ */ React8.createElement(
    ...
    typeof document === 'undefined' && deferredData && dataKey && routeId
      ? /* @__PURE__ */ React8.createElement(Await2, {
          resolve: deferredData.data[dataKey],
          errorElement: /* @__PURE__ */ React8.createElement(
...
var LiveReload =
  ...
  false
    ? () => null
    : function LiveReload2({ origin, port, timeoutMs = 1e3, nonce = void 0 }) {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"node_modules\\\\@remix-run\\\\react\\\\dist\\\\esm\\\\browser.js"' + id
    );
  };
  window.$RefreshSig$ =
...
if (import.meta && import.meta.hot) {
  import.meta.hot.accept(
    'remix:manifest',
    async ({ assetsManifest, needsRevalidation }) => {
          ...
          (
            await Promise.all(
              routeIds.map(async (id) => {
                var _assetsManifest$hmr,
                  _window$__remixRouteM,
                  _window$__remixRouteM2,
                  _window$__remixRouteM3;
                ...
                let imported = await import(
                  assetsManifest.routes[id].module +
                    `?t=${
                      (_assetsManifest$hmr = assetsManifest.hmr) === null ||
                      _assetsManifest$hmr === void 0
                        ? void 0
                        : _assetsManifest$hmr.timestamp
                    }`
                );
                return [
                  id,
                  {
                    ...
                    default: imported.default
                      ? ((_window$__remixRouteM =
                          window.__remixRouteModules[id]) === null ||
                        _window$__remixRouteM === void 0
                          ? void 0
                          : _window$__remixRouteM.default) ?? imported.default
                      : imported.default,
                    ErrorBoundary: imported.ErrorBoundary
                      ? ((_window$__remixRouteM2 =
                          window.__remixRouteModules[id]) === null ||
                        _window$__remixRouteM2 === void 0
                          ? void 0
                          : _window$__remixRouteM2.ErrorBoundary) ??
                        imported.ErrorBoundary
                      : imported.ErrorBoundary,
                    HydrateFallback: imported.HydrateFallback
                      ? ((_window$__remixRouteM3 =
                          window.__remixRouteModules[id]) === null ||
                        _window$__remixRouteM3 === void 0
                          ? void 0
                          : _window$__remixRouteM3.HydrateFallback) ??
...
function RemixBrowser(_props) {
  ...
  if (!router) {
    ...
    let { enabled: isFogOfWarEnabled2, patchRoutesOnMiss } = initFogOfWar(
  ...
  let [criticalCss, setCriticalCss] = React9.useState(
    true ? window.__remixContext.criticalCss : void 0
  );
  if (true) {
  ...
  return (
    ...
    /* @__PURE__ */ React9.createElement(
      ...
      window.__remixContext.future.unstable_singleFetch
        ? /* @__PURE__ */ React9.createElement(React9.Fragment, null)
        : null
    )
  );
}
...
function ScrollRestoration2({ getKey, ...props }) {
...
function RemixServer({ context, url, abortDelay, nonce }) {
  ...
  let router2 = (0, import_server.createStaticRouter)(
    routes,
  ...
  return /* @__PURE__ */ React11.createElement(
    ...
    context.future.unstable_singleFetch && context.serverHandoffStream
      ? /* @__PURE__ */ React11.createElement(
          React11.Suspense,
          null,
          /* @__PURE__ */ React11.createElement(StreamTransfer, {
            context,
            identifier: 0,
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-VYZRAVYK.js.map
